    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9 col-md-7">
                    ...
                    <div class="row">
                        <div class="product__discount__slider owl-carousel">
                            <div class="col-lg-4">
                                <div class="product__discount__item">
                                    <div class="product__discount__item__pic set-bg"
                                         data-setbg="{{asset('frontend')}}/img/product/discount/pd-1.jpg">
                            ...
                            <div class="col-lg-4">
                                <div class="product__discount__item">
                                    <div class="product__discount__item__pic set-bg"
                                         data-setbg="{{asset('frontend')}}/img/product/discount/pd-3.jpg">
                                        <div class="product__discount__percent">-20%</div>
                                        <ul class="product__item__pic__hover">
                                            <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                            <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                            ...
                            <div class="col-lg-4">
                                <div class="product__discount__item">
                                    <div class="product__discount__item__pic set-bg"
                                         data-setbg="{{asset('frontend')}}/img/product/discount/pd-4.jpg">
                                        <div class="product__discount__percent">-20%</div>
                                        <ul class="product__item__pic__hover">
                                            <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                            <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                            ...
                            <div class="col-lg-4">
                                <div class="product__discount__item">
                                    <div class="product__discount__item__pic set-bg"
                                         data-setbg="{{asset('frontend')}}/img/product/discount/pd-5.jpg">
                                        <div class="product__discount__percent">-20%</div>
                                        <ul class="product__item__pic__hover">
                                            <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                            <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                            ...
                            <div class="col-lg-4">
                                <div class="product__discount__item">
                                    <div class="product__discount__item__pic set-bg"
                                         data-setbg="{{asset('frontend')}}/img/product/discount/pd-6.jpg">
                                        <div class="product__discount__percent">-20%</div>
                                        <ul class="product__item__pic__hover">
                                            <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                            <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="filter__found">
                                <?php
                               $all =  \App\Models\Admin\Product::where('status','active')->get();
                                ?>
                ...
                <div class="row">
                    <?php
                    $showAll =  \App\Models\Admin\Product::where('status','active')->latest()->paginate(12);
                    ?>
                    @foreach($showAll as $show)
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div style="border:4px solid #f3f4f9;" class="product__item">
                            <div class="product__item__pic set-bg" data-setbg="{{asset($show->first_image)}}">
                                <ul class="product__item__pic__hover">
                                    <li>
                                        @if(session()->has('LoggedCustomer'))
                                            <form action="{{ route('wishlist') }}" method="post">
                                                ...
                                                <input type="hidden" name="brand_id" value="{{ $show->brand_id }}">
                                                <input type="hidden" name="first_image" value="{{ $show->first_image }}">
                                                <input type="hidden" name="second_image" value="{{ $show->second_image }}">
                                                <input type="hidden" name="third_image" value="{{ $show->third_image }}">
                                                <input type="hidden" name="fourth_image" value="{{ $show->fourth_image }}">
                                                <button
                                    ...
                                    <li><a href="{{ route('productDetail',$show->id) }}"><i class="fa fa-eye"></i></a></li>
                                    <li>
                            ...
                            <div class="product__item__text">
                                <h6><a href="{{ route('productDetail',$show->id) }}">{{ $show->brand->brand }}</a></h6>
                                <h5>{{ number_format($show->price) }}&#2547;</h5>
                            </div>
                        </div>
                    </div>
                    @endforeach
